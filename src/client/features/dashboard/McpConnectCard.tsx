...
function firstPrompts(domain: string | null): string[] {
  ...
  return [
    `Review ${site}. Ideas for what keywords we could target? Use Deep Insights`,
    "Research my competitors top pages and keywords and tell me what's working. Use Deep Insights",
  ];
}
        ...
        {connected ? (
          ...
          <>
            <div className="space-y-2 text-sm text-base-content/70">
              <p>
                Deep Insights is designed to give your AI agent the data it needs to
