...
async function missingSelfHostedGoogleClientResponse(
  ...
  return mcpResponse({
    text: `This self-hosted Deep Insights deployment is not configured for Search Console yet. Set GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET, and BETTER_AUTH_SECRET, then reconnect Search Console from the project's settings page. Help: ${GSC_SELF_HOSTED_SETUP_DOCS_URL}`,
