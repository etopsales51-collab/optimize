...
export const whoamiTool = {
  ...
  config: {
    title: "Who am I",
    description:
      "Confirms the connected Deep Insights account, server mode, token scopes, and current credit balance when the user asks to check their account or connection. Uses no credits — does not call DataForSEO.",
